...
# Since we are using re.I both lowercase and uppercase letters are included. If we do not have the
# re.I flag, then we will have to write our pattern differently. Let us check it out:
